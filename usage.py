...
class Usage():
	...
	def reset(self):
		...
		self.check = [0,0]
		self.dolar = [0,0]
		self.mep = [0,0,0] #button, custom, errors...
		self.cashornot = [0,0,0] #start, success, errors...
	...
	#Registering a new cashornot...
	def add_cashornot(self, key):
		self.cashornot[key] += 1
